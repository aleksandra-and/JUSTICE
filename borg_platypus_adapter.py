...
#                 self._lever_names = [lv.name for lv in getattr(self.evaluator.model, "levers", [])]
#                 self._outcome_names = [oc.name for oc in getattr(self.evaluator.model, "outcomes", [])]
#         except Exception:
#             pass
...
#                     policy_obj = Policy("borg-policy", **dict(zip(self._lever_names, x_list)))
#                 else:
