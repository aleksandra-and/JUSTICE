...
srun python thesis_rl/train_momarl.py --load_config 'thesis_rl/configs/happo_temp_econ.yaml' \
    --wandb_project momarl_happo_mappo_2 \
    --weights_generation uniform \
    --num_weights $TOTAL_WEIGHTS \
    --start_uniform_weight $START_WEIGHT \
    --end_uniform_weight $END_WEIGHT > run_momarl_happo_${SLURM_ARRAY_TASK_ID}.log
